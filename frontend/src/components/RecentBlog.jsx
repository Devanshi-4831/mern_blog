...
const RecentBlog = () => {
    ...
    useEffect(() => {
        const getAllPublsihedBlogs = async () => {
            try {
                const res = await axios.get(`https://mern-blog-i2ok.onrender.com/api/v1/blog/get-published-blogs`, { withCredentials: true })
                if (res.data.success) {
                ...
                <div className='bg-white hidden md:block dark:bg-gray-700 w-[350px] p-5 rounded-md mt-10'>
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 max-w-md mx-auto mt-5">
                        <Input
                            ...
                            className="flex h-10 w-full rounded-md border bg-gray-200 dark:bg-gray-700 px-3 py-2 text-sm  text-black-300"
                        />
